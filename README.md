...
Items that already have extracted text, items of other formats, and items whose
fetch failed are refused, since replacing the text would leave the item's
summaries describing content it no longer carries.
